...
export const styles = sortCx({
    common: {
        root: [
            "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap outline-brand transition duration-100 ease-linear before:absolute focus-visible:outline-2 focus-visible:outline-offset-2 active:brightness-95 data-[pressed]:brightness-95",
    ...
    colors: {
        primary: {
            root: [
                "bg-neutral-900 text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-black data-loading:bg-black",
                // Inner border gradient
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                // Disabled styles
                "disabled:bg-disabled disabled:shadow-xs disabled:ring-disabled_subtle",
                // Icon styles
                "*:data-icon:text-white/80 hover:*:data-icon:text-white",
            ].join(" "),
        },
        secondary: {
            root: [
                "bg-neutral-900 text-white shadow-xs-skeumorphic ring-1 ring-neutral-900 ring-inset hover:bg-black data-loading:bg-black",
                // Disabled styles
