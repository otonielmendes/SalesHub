...
import { DemoHistoricoTable } from "@/app/fingerprinting/_components/DemoHistoricoTable";
import { DemoHistoricoHeaderActions } from "@/app/fingerprinting/_components/DemoHistoricoHeaderActions";
  ...
  return (
    <div className="mx-auto max-w-container px-6 py-8 lg:px-8">
      ...
      <nav aria-label="Breadcrumb" className="mb-10 flex flex-wrap items-center gap-3 text-sm text-[#475456]">
        <Link href="/fingerprinting/new" className="rounded-md p-1 transition-colors hover:bg-[#EAECEE]" aria-label="Fingerprinting">
