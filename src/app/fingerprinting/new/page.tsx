  ...
  return (
    <div className={WIZARD_PAGE_SHELL_CLASS}>
      <nav aria-label="Breadcrumb" className={WIZARD_BREADCRUMB_CLASS}>
        <Link href="/fingerprinting/history" className="rounded-lg p-1 transition-colors hover:bg-[#EAECEE]" aria-label={tc("homeAria")}>
          <HomeLine className="h-5 w-5" />
        </Link>
        <span className="text-[#D0D5D7]">/</span>
        <Link href="/fingerprinting/history" className="rounded-lg px-2 py-1 font-medium transition-colors hover:bg-[#EAECEE]">
          ...
          <section className={WIZARD_SECTION_CLASS}>
            ...
            <div className={WIZARD_SECTION_BODY_CLASS}>
              ...
              <div className="mt-6 flex flex-col gap-3 border-t border-[#EAECF0] pt-6 sm:flex-row lg:hidden">
                <Button href={sessionId ? `/fingerprinting/${sessionId}` : undefined} isDisabled={!isReady} size="md" className="flex-1">
                  {t("openSession")}
                </Button>
                <Button
                  type="button"
        ...
        <aside className={WIZARD_SIDEBAR_CLASS}>
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-[#D0D5DD] bg-white p-4 shadow-xs">
              <Button href={sessionId ? `/fingerprinting/${sessionId}` : undefined} isDisabled={!isReady} size="lg" className="w-full">
                {t("openSession")}
              </Button>
              <Button
                type="button"
